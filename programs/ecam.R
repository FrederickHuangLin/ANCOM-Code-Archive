...
write_csv(res$out, "outputs/ecam_rand_int.csv")
...
fig  
ggsave("images/ecam_rand_int.jpeg", height = 5, width = 6.25, units = "in", dpi = 300) 

# ============Random intercept model + covariates adjustment====================
...
write_csv(res$out, "outputs/ecam_rand_int_cov_adj.csv")
...
fig = res$fig + 
  ...
  geom_text(data = dat_ann, aes(x = x, y = y, label = label), 
            size = 4, vjust = -0.5, hjust = 0, color = "orange", parse = TRUE)
fig  
ggsave("images/ecam_rand_int_cov_adj.jpeg", height = 5, width = 6.25, units = "in", dpi = 300) 
...
write_csv(res$out, "outputs/ecam_rand_slope.csv")
...
fig = res$fig + 
  ...
  geom_text(data = dat_ann, aes(x = x, y = y, label = label), 
            size = 4, vjust = -0.5, hjust = 0, color = "orange", parse = TRUE)
fig  
ggsave("images/ecam_rand_slope.jpeg", height = 5, width = 6.25, units = "in", dpi = 300) 
